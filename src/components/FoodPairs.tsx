  ...
  return (
    <Group position='center'>
      <Container size='xs' px='xs'>
        <Group>
          <Image src={JerkChicken} fit='contain' width={100} height={100} />
          <Stack>
      ...
      <Container size='xs' px='xs'>
        <Group>
          <Image src={ShrimpCakes} fit='contain' width={100} height={100} />
          <Stack>
      ...
      <Container size='xs' px='xs'>
        <Group>
          <Image src={Enchiladas} fit='contain' width={100} height={100} />
          <Stack>
